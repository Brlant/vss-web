      ...
      },
      {
        ...
        children: [
          ...
          },
          {
            ...
            component: () => import('./components/pov/inoculate/vaccine-each/index'),
      ...
      // },
      {
        ...
        children: [
          ...
          },
          {
            ...
            meta: {moduleId: 'store', title: '期初库存录入', perm: 'cerp-stock-batch-adjust'}
          },
          {
        ...
        children: [
          {
            ...
            component: () => import('./components/report/wastage-report-vss'),
          ...
          {
            path: '/report/receive/records',
            component: () => import('./components/report/receive-record.vue'),
            meta: {moduleId: 'report', title: '收货记录表', perm: 'erp-receiving-record-query'}
          },
        ]
      },
      {
