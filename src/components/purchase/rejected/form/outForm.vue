        ...
        <el-form ref="orderAddForm" :model="form" :rules="rules" label-width="160px" onsubmit="return false"
          ...
          <div class="hide-content" v-bind:class="{'show-content' : index==0}">
            ...
            <el-form-item label="供货单位" prop="customerId">
              <el-select v-model="form.customerId" :clearable="true" :remote-method="filterOrg" filterable placeholder="请输入名称搜索供货单位"
            ...
            <el-form-item v-show="showContent.isShowOtherContent"
                          label="供货单位仓库">
              <el-select v-model="form.transportationAddress" clearable filterable placeholder="请选择供货单位仓库"
