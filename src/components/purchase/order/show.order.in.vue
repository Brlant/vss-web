  ...
  <div>
    <div class="content-part">
        ...
        <ul>
          ...
          <li class="text-center order-btn" style="margin-top: 40px">
            <perm v-show="currentOrder.state === '6' "
                  :label="vaccineType === '1'?'purchasing-order-audit': 'second-vaccine-purchasing-order-audit' ">
          ...
          <li class="text-center order-btn" style="margin-top: 10px">
            <perm v-show="currentOrder.state === '6' || currentOrder.state === '7' || currentOrder.state === '10' "
                  :label="vaccineType === '1'?'purchasing-order-cancel': 'second-vaccine-purchasing-order-cancel' ">
      ...
      <div class="content-right content-padding">
        <h3>{{ title }}</h3>
        <basic-info v-show="index === 0" :currentOrder="currentOrder" :index="index"
