          ...
          <el-form ref="orderAddForm" :model="form" :rules="rules" label-width="160px" onsubmit="return false"
            ...
            <el-form-item label="供货单位" prop="supplierId">
              <el-select v-model="form.supplierId" :clearable="true" :remote-method="filterOrg" filterable placeholder="请输入名称搜索供货单位"
                         remote @change="changeSupplier">
                <el-option v-for="org in orgList" :key="org.id" :label="org.name" :value="org.id">
                  <div style="overflow: hidden">
                    <span class="pull-left" style="clear: right">{{org.name}}</span>
                    <span v-if="org.relationList" class="pull-right select-other-info">
            ...
            <el-form-item label="仓库地址" prop="transportationAddress">
              <el-select v-model="form.transportationAddress" :clearable="true"
                         filterable placeholder="请选择仓库地址">
          ...
          <div class="product-list-detail">
            ...
            <table class="table">
              ...
              <tr>
                ...
                <th>规格</th>
                <th v-show="vaccineType==='2'">疫苗单价</th>
                <th>疫苗数量</th>
