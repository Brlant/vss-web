          ...
          <el-row>
            ...
            <el-col :span="8">
              <oms-form-row :span="3" label="">
                ...
                <perm label="injection-subordinate-signed-export">
        ...
        <div v-else="" class="order-list-body flex-list-dom">
          <div v-for="item in recordList" :key="" class="order-list-item order-list-item-bg">
            <el-row>
              ...
              <el-col :span="2">
                <img v-if="item.signedFile&&item.signedFile.attachmentStoragePath"
                     :src="item.signedFile&&item.signedFile.attachmentStoragePath"
...
export default {
  ...
  methods: {
    ...
    getRecordPage(pageNo) { // 得到波次列表
      ...
      this.$http.get('/injection-task/subordinate/signed', {params}).then(res => {
    ...
    exportFile: function () {// 导出表单
      ...
      this.$http.get('/injection-task/subordinate/signed/export', {params}).then(res => {
