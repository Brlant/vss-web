  ...
  <div>
    ...
    <el-form ref="form" :model="form" :rules="rules" label-width="100px"
      ...
      <el-form-item label="姓名" prop="inoculatorName">
        <oms-input v-model.trim="form.inoculatorName" placeholder="请输入姓名" type="text"></oms-input>
      </el-form-item>
      ...
      <el-form-item label="生日" prop="inoculatorBirthday">
        <el-date-picker v-model="form.inoculatorBirthday" format="yyyy-MM-dd" placeholder="请选择生日"
                        value-format="timestamp">
        </el-date-picker>
      </el-form-item>
      <el-form-item label="接种证编号">
        <oms-input v-model.trim="form.inoculatorNumber" placeholder="请输入接种证编号" type="text"></oms-input>
      </el-form-item>
      <el-form-item label="身份证" prop="inoculatorCardNumber">
        <oms-input v-model.trim="form.inoculatorCardNumber" placeholder="请输入身份证" type="text"></oms-input>
      </el-form-item>
      <el-form-item label="出生证号">
        <oms-input v-model.trim="form.birthCertificateNumber" placeholder="请输入出生证号" type="text"></oms-input>
      </el-form-item>
      <el-form-item label="备注">
        <oms-input v-model.trim="form.inoculatorRemarks" placeholder="请输入备注" type="textarea"></oms-input>
      </el-form-item>
