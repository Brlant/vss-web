          ...
          <el-row>
            <el-col :span="8">
              <oms-form-row :span="5" label="货主疫苗">
                <el-select v-model="searchWord.goodsId" :clearable="true" :remote-method="filterOrgGoods"
                           filterable
                           placeholder="请输入名称搜索货主疫苗"
                           popper-class="good-selects"
                           remote @change="goodsChange"
            ...
            <el-col :span="8">
              <oms-form-row :span="6" label="批号">
                <el-select v-model="searchWord.batchNumberId" :remoteMethod="filterBatchNumber" clearable
                           filterable
