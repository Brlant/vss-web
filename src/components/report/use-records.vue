    ...
    <div class="container">
      <div :class="{up:!showSearch}" class="opera-btn-group">
        ...
        <el-form v-show="showSearch" class="advanced-query-form clearfix" onsubmit="return false"
          ...
          <el-row>
            <el-col :span="9">
              <oms-form-row :span="8" is-require label="接种时间">
                <el-date-picker
                  v-model="actualTime"
      ...
      <div class="order-list clearfix" style="height: 1000px">
        ...
        <div v-else class="order-list-body flex-list-dom">
          <div v-for="item in taskList" class="order-list-item order-list-item-bg">
            <el-row>
              <el-col :span="4">
                {{item.povName}}
              </el-col>
              ...
              <el-col :span="6">
                ...
                <div v-show="item.batchReleaseNumber" class="font-gray">批签发号：{{item.batchReleaseNumber}}</div>
              </el-col>
              <el-col :span="2">
