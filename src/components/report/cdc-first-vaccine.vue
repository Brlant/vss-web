  ...
  <div class="order-page">
    <div class="container">
      <div :class="{up:!showSearch}" class="opera-btn-group">
        ...
        <el-form class="advanced-query-form">
          <el-row>
            ...
            <!--</el-col>-->
            <el-col :span="8">
              <oms-form-row :span="6" label="业务日期">
                <el-col :span="24">
                  <el-date-picker
                    v-model="bizDateAry"
                    format="yyyy-MM-dd"
          ...
          <el-row>
            <el-col :span="12">
              <oms-form-row :span="7" label="供/收货单位名称">
                <el-select v-model="searchWord.customerId" :clearable="true" :loading="selectLoading"
                           :remote-method="filterProvide" filterable placeholder="请输入供/收货单位名称查询"
                           popperClass="good-selects" remote
                           @click.native.once="filterProvide('')">
                  <el-option v-for="org in provideList" :key="org.id" :label="org.name" :value="org.id">
                    <div style="overflow: hidden">
                      <span class="pull-left" style="clear: right">{{org.name}}</span>
                    </div>
                    <div style="overflow: hidden">
      ...
      <el-table ref="reportTable" v-loading="loadingData" :data="reportChildList" :header-row-class-name="'headerClass'" :maxHeight="getHeight"
        ...
        <el-table-column :sortable="true" label="出入库详细" min-width="120" prop="bizType">
        ...
        <el-table-column :sortable="true" label="日期" min-width="100" prop="date"></el-table-column>
