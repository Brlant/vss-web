  ...
  <div class="order-page">
    <div class="container">
      ...
      <el-table :data="reportList" :header-row-class-name="'headerClass'" :maxHeight="getHeight" border
        ...
        <el-table-column label="供货单位" prop="saleFilmName" min-width="150px"></el-table-column>
        <el-table-column label="疫苗名称" prop="vaccineName" min-width="200px"></el-table-column>
        <el-table-column label="规格" prop="specification" min-width="150px"></el-table-column>
