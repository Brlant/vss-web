<template>
  <div>
    <el-row>
      <el-col :span="18">
        <object id="view1" height="400" name="view" type="application/x-eloamplugin" width="100%"></object>
      </el-col>
      <el-col :span="6">
        <object id="thumb1" height="400" name="thumb" type="application/x-eloamplugin" width="100%"></object>
      </el-col>
    </el-row>
    <div style="margin-top:20px">
      <el-button @click="Scan">拍照</el-button>
      <el-button class="pull-right" type="primary" @click="close">确 定</el-button>
    </div>
  </div>
</template>
