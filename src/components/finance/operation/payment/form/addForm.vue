      ...
      <div class="content-right min-gutter">
        ...
        <div>
          <el-form ref="addForm" :rules="rules" :model="form" @submit.prevent="onSubmit" onsubmit="return false"
            ...
            <el-form-item label="应付总金额" v-if="payableTotalAmount">
              <span v-if="payableTotalAmount">¥</span>{{payableTotalAmount}}
            </el-form-item>
            <el-form-item label="实付总金额" v-if="practicalTotalAmount">
              <span v-if="practicalTotalAmount">¥</span>{{practicalTotalAmount}}
            </el-form-item>
            <el-form-item label="未付总金额" v-if="notTotalAmount">
              <span v-if="notTotalAmount">¥</span>{{notTotalAmount}}
            </el-form-item>
            ...
            <el-form-item label="金额" prop="amount">
              <oms-input type="text" v-model="form.amount" @blur="formatPrice"
                         placeholder="请输入金额,最多保留两位小数">
...
<script>
  import {http, Address, BaseInfo, pay} from '../../../../../resources';
        ...
        if (this.form.id) {
          if (this.form.billPayType === '0') {
            ...
            this.orgList.forEach(val => {
              if (this.form.id === val.remitteeId) {
