        ...
        <div v-if="!loadingData">
          <el-row>
            ...
            <el-col :span="12">
              ...
              <oms-row v-show="form.status !=='0'" :span="8" label="审批意见">
                <span>
          ...
          <ul v-if="form.detailList.length"
            ...
            <li class="show-item" style="background: #f1f1f1">
              <el-row type="flex">
                ...
                <el-col v-show="form.billPayType === '1'" :span="4">关联发票号</el-col>
                <el-col :span="form.billPayType === '1' ? 3 : 4">发生时间</el-col>
                <el-col :span="form.billPayType === '1' ? 3 : 4">本次付款金额</el-col>
                <el-col v-show="form.status ==='0'" :span="2">操作</el-col>
              </el-row>
            </li>
            <li v-for="item in form.detailList" class="show-item">
              <el-row type="flex">
                ...
                <el-col v-show="form.billPayType === '1'" :span="4" class="break-word">
                ...
                <el-col v-show="form.status ==='0'" :span="2">
          ...
          <oms-row v-show="form.status ==='0'" :span="4" label="审批意见">
            <oms-input v-model="form.auditOpinion" :autosize="{ minRows: 2, maxRows: 5}" placeholder="请输入审批意见"
                       type="textarea"></oms-input>
          </oms-row>
          <oms-row :span="form.status ==='0' ? 4 : 2" class="mt-10" label="">
            <perm label="payment-payable-audit">
              <el-button v-show="form.status ==='0'" :plain="true" native-type="submit" style="width: 100px"
                         type="success"
                         @click="audited">审核通过
              </el-button>
              <el-button v-show="form.status ==='0'" :plain="true" native-type="submit" style="width: 100px"
              ...
              <el-button v-show="form.status ==='1'" :plain="true" native-type="submit" style="width: 100px" type="danger"
                         @click="review">
                通过复核
              </el-button>
            </perm>
