    ...
    <div class="container">
      <div :class="{up:!showSearch}" class="opera-btn-group">
        <div class="opera-icon">
          <span class="pull-right cursor-span" style="margin-left: 10px" @click.prevent="add">
            <perm label="allocating-out-order-add">
          ...
          <span v-show="isShowCheckBox" class="pull-right cursor-span" style="margin-right: 15px"
            ...
            <perm label="allocating-out-order-batch-audit">
                  <a class="btn-circle" href="#" @click.prevent=""><i
      ...
      <div class="order-list clearfix">
        <el-row class="order-list-header">
          ...
          <el-col v-if="filters.state === '0'" :span="3">操作</el-col>
        </el-row>
          ...
          <div v-for="item in orderList" :class="['status-'+filterListColor(item.state),{'active':currentOrderId==item.id}]" class="order-list-item"
            ...
            <el-row>
              ...
              <el-col :span="3" class="opera-btn">
                <perm v-if="filters.state === '0' || filters.state === '1' " label="allocating-out-order-edit">
...
//          this.pager.count = res.data.count;
    ...
    showItem: function (order) {
      ...
      this.$nextTick(() => {
        ...
        this.showDetail = true;
        this.$router.push(`/store/allotment/out/${order.id}`);
      });
    },
