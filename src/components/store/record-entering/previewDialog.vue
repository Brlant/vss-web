<template>
  <el-table v-if="dialogVisible" v-loading="loadingData" :data="formItem"
            :header-row-class-name="'headerClass'"
            :row-class-name="formatRowClass" :summary-method="getSummaries" border
            class="header-list store border-black"
    ...
    <el-table-column align="center" label="单位" min-width="40"
                     prop="orgGoodsDto.goodsDto.measurementUnit"></el-table-column>
