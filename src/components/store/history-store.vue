    ...
    <div class="container">
      <div :class="{up:!showSearch}" class="opera-btn-group">
        ...
        <el-form class="advanced-query-form" onsubmit="return false">
          <el-row>
            <el-col :span="8">
              <oms-form-row :span="5" isRequire label="备份日期">
                <el-col :span="24">
                  <el-date-picker
      ...
      <div>
        ...
        <div v-else-if="!batches.length" class="empty-info">暂无数据</div>
        <el-table v-else v-show="batches.length" :data="batches" :header-row-class-name="'headerClass'"
                  :max-height="bodyHeight" :row-class-name="formatRowClass"
                  :summary-method="getSummaries" border class="header-list store border-black no-pointer"
                  show-summary style="width: 100%" @cell-mouse-enter="cellMouseEnter" @cell-mouse-leave="cellMouseLeave">
          <el-table-column :sortable="true" label="货主疫苗名称" min-width="200" prop="goodsName"></el-table-column>
          <el-table-column :sortable="true" label="疫苗通用名称" min-width="200" prop="platformGoodsName"></el-table-column>
      ...
      <div v-show="pager.count>pager.pageSize && !loadingData && batches.length" class="text-center">
        <el-pagination
