    ...
    <div class="container">
      <div class="order-list-status container">
        <div class="status-item" :class="{'active':key===activeStatus}"
             v-for="(item,key) in inventoryType" @click="checkStatus(item, key)">
      ...
      <div class="order-list clearfix" style="margin-top: 20px">
        ...
        <div v-else class="order-list-body flex-list-dom">
          <div class="order-list-item" v-for="item in inventories"
            ...
            <el-row>
              ...
              <el-col :span="3" style="padding-top: 5px">
                <el-tag type="warning" v-show="item.status === 0">待操作</el-tag>
