    ...
    <div class="content-part">
      <div class="content-right content-padding">
        ...
        <el-row class="batch-info">
          ...
          <el-col :span="12">
            <oms-row label="业务人份剂次" :span="span" v-if="isBizServing">{{ currentItem.qualifiedBizServings }}</oms-row>
            ...
            <oms-row label="实物人份剂次" :span="span" v-if="isBizServing">{{ currentItem.qualifiedActualServings }}</oms-row>
