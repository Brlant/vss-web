      ...
      <div class="content-right min-gutter">
        <div class="hide-content show-content">
          <el-form ref="d-form" :model="form" :rules="rules" label-width="200px" style="padding-right: 20px">
            ...
            <el-form-item v-if="form.model==='0'" label="免疫规划疫苗物流费用" prop="price">
              <oms-input v-model="form.price" :min="0" placeholder="请输入免疫规划疫苗物流费用" type="text"
                         @blur="formatPrice">
                <template slot="prepend">¥</template>
              </oms-input>
            </el-form-item>
            <el-form-item v-if="form.model==='1'" label="免疫规划疫苗物流费用比例" prop="proportion">
              <oms-input v-model="form.proportion" :min="0" placeholder="请输入免疫规划疫苗物流费用比例" type="text">
