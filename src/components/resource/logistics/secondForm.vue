      ...
      <div class="content-right min-gutter">
        <div class="hide-content show-content">
          <el-form ref="d-form" :rules="rules" :model="form" label-width="200px" style="padding-right: 20px">
            ...
            <el-form-item label="非免疫规划疫苗物流费用" prop="price" v-if="form.model==='0'">
              <oms-input type="text" placeholder="请输入非免疫规划疫苗物流费用" v-model="form.price" :min="0"
                         @blur="formatPrice">
                <template slot="prepend">¥</template>
              </oms-input>
            </el-form-item>
            <el-form-item label="非免疫规划疫苗物流费用比例" prop="proportion" v-if="form.model==='1'">
              <oms-input type="text" placeholder="请输入非免疫规划疫苗物流费用比例" v-model="form.proportion" :min="0">
