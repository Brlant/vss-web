  ...
  <div>
    <div class="content-part">
      <div class="content-left">
        <h2 class="clearfix right-title" style="font-size: 16px">{{setTitle}}非免疫规划疫苗物流费用</h2>
        <ul>
      ...
      <div class="content-right min-gutter">
        <div class="hide-content show-content">
          <el-form ref="d-form" :model="form" :rules="rules" label-width="200px" style="padding-right: 20px">
            <el-form-item label="非免疫规划疫苗物流费用模式" prop="model">
              <el-select v-model="form.model" placeholder="请选择非免疫规划疫苗物流费用模式">
                <el-option label="单支" value="0"></el-option>
                <el-option label="比例" value="1"></el-option>
              </el-select>
            </el-form-item>
            <el-form-item v-if="form.model==='0'" label="非免疫规划疫苗物流费用" prop="price">
              <oms-input v-model="form.price" :min="0" placeholder="请输入非免疫规划疫苗物流费用" type="text"
                         @blur="formatPrice">
                <template slot="prepend">¥</template>
              </oms-input>
            </el-form-item>
            <el-form-item v-if="form.model==='1'" label="非免疫规划疫苗物流费用比例" prop="proportion">
              <oms-input v-model="form.proportion" :min="0" placeholder="请输入非免疫规划疫苗物流费用比例" type="text">
  ...
  data() {
    return {
      ...
      rules: {
        ...
        price: {required: true, message: '请输入非免疫规划疫苗物流费用', trigger: 'blur'},
        proportion: {required: true, message: '请输入非免疫规划疫苗物流费用比例', trigger: 'blur'}
      },
      doing: false
    };
  },
